...
import { SUMMARY_TABS } from '../constants';
import type { SummaryTab, MonthContent, TabType } from '../types';
...
interface SummaryContentSectionProps {
  ...
  onSaveEdit: () => void;
  onCancelEdit: () => void;
  onStartEditSummary: (tab: SummaryTab) => void;
  onOpenAIGenerationModal: () => void;
}

export default function SummaryContentSection({
  activeTab,
  activeSection,
  currentSummaryId,
  currentTabData,
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        ...
        {editingMonth === activeTab && editingSection === currentSummaryId ? (
          ...
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            ...
            <button
              onClick={() => onStartEditSummary(activeTab as SummaryTab)}
              style={{
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
