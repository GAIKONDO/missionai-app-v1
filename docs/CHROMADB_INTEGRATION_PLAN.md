...
impl ChromaDBServer {
    pub async fn start(data_dir: PathBuf, port: u16) -> Result<Self, String> {
        ...
        if health_check.is_err() {
            return Err("ChromaDBサーバーの起動確認に失敗しました".to_string());
        }
    ...
    fn find_python() -> Result<String, String> {
        // Python 3.8-3.11を探す
        let candidates = vec!["python3.11", "python3.10", "python3.9", "python3.8", "python3", "python"];
        ...
        Err("Python環境が見つかりません。Python 3.8-3.11が必要です。".to_string())
    }
